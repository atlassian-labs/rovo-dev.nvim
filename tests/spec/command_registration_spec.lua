...
describe('command registration', function()
  ...
  describe('command execution', function()
    it('should call toggle when RovoDev command is executed', function()
      ...
      assert.is_true(
        toggle_called,
        'Toggle function should be called when RovoDev command is executed'
      )
    end)
    ...
    it('should call notify with version when RovoDevVersion command is executed', function()
      ...
      assert.is_true(
        notify_called,
        'vim.notify should be called when RovoDevVersion command is executed'
      )
      assert.is_not_nil(notify_message, 'Notification message should not be nil')
      assert.is_not_nil(
        string.find(notify_message, 'Rovo Dev version'),
